...
package org.javasavvy.leave.core.service.service.persistence.impl;
...
import org.javasavvy.leave.core.service.exception.NoSuchLeaveException;
import org.javasavvy.leave.core.service.model.Leave;
import org.javasavvy.leave.core.service.model.impl.LeaveImpl;
import org.javasavvy.leave.core.service.model.impl.LeaveModelImpl;
 ...
 * @see org.javasavvy.leave.core.service.service.persistence.LeaveUtil
 * @generated
 */
@ProviderType
public class LeavePersistenceImpl extends BasePersistenceImpl<Leave>
	...
	/**
	 * Returns all the leaves where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<Leave> findBystatus(long groupId, int status) {
		return findBystatus(groupId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the leaves where groupId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link LeaveModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Leave> findBystatus(long groupId, int status, int start, int end) {
		return findBystatus(groupId, status, start, end, null);
	}

	/**
	 * Returns an ordered range of all the leaves where groupId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link LeaveModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Leave> findBystatus(long groupId, int status, int start,
		int end, OrderByComparator<Leave> orderByComparator) {
	...
	/**
	 * Returns the first leave in the ordered set where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Leave findBystatus_First(long groupId, int status,
		OrderByComparator<Leave> orderByComparator) throws NoSuchLeaveException {
		Leave leave = fetchBystatus_First(groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Leave fetchBystatus_First(long groupId, int status,
		OrderByComparator<Leave> orderByComparator) {
		List<Leave> list = findBystatus(groupId, status, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last leave in the ordered set where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Leave findBystatus_Last(long groupId, int status,
		OrderByComparator<Leave> orderByComparator) throws NoSuchLeaveException {
		Leave leave = fetchBystatus_Last(groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Leave fetchBystatus_Last(long groupId, int status,
		OrderByComparator<Leave> orderByComparator) {
		...
		List<Leave> list = findBystatus(groupId, status, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the leaves before and after the current leave in the ordered set where groupId = &#63; and status = &#63;.
	 *
	 * @param leaveId the primary key of the current leave
	 * @param groupId the group ID
	 * @param status the status
	 ...
	 */
	@Override
	public Leave[] findBystatus_PrevAndNext(long leaveId, long groupId,
		int status, OrderByComparator<Leave> orderByComparator)
		throws NoSuchLeaveException {
		Leave leave = findByPrimaryKey(leaveId);
		...
		try {
			...
			array[0] = getBystatus_PrevAndNext(session, leave, groupId, status,
					orderByComparator, true);

			array[1] = leave;

			array[2] = getBystatus_PrevAndNext(session, leave, groupId, status,
					orderByComparator, false);
	...
	protected Leave getBystatus_PrevAndNext(Session session, Leave leave,
		long groupId, int status, OrderByComparator<Leave> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the leaves where groupId = &#63; and status = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 */
	...
	public void removeBystatus(long groupId, int status) {
		for (Leave leave : findBystatus(groupId, status, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(leave);
		}
	}
	...
	/**
	 * Returns the number of leaves where groupId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param status the status
	 * @return the number of matching leaves
	...
	private static final String _FINDER_COLUMN_STATUS_GROUPID_2 = "leave.groupId = ? AND ";
	private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "leave.status = ?";
	...
	public Leave updateImpl(Leave leave) {
		...
		if (!LeaveModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					leaveModelImpl.getGroupId(), leaveModelImpl.getStatus()
				};
			...
			if ((leaveModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						leaveModelImpl.getOriginalGroupId(),
						leaveModelImpl.getOriginalStatus()
					};
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
				FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll",
				new String[0]);

		_finderPathCountAll = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll",
				new String[0]);

		_finderPathWithPaginationFindByUuid = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathCountByUuid = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
				new String[] { String.class.getName() });

		_finderPathFetchByUUID_G = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathCountByUUID_G = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUUID_G",
				new String[] { String.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByUuid_C = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathCountByUuid_C = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
				new String[] { String.class.getName(), Long.class.getName() });

		_finderPathWithPaginationFindByuserId = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathWithoutPaginationFindByuserId = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathCountByuserId = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, Long.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByuserId",
				new String[] { Long.class.getName() });

		_finderPathWithPaginationFindBystatus = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
		...
		_finderPathWithoutPaginationFindBystatus = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, LeaveImpl.class,
				FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBystatus",
				new String[] { Long.class.getName(), Integer.class.getName() },
				LeaveModelImpl.GROUPID_COLUMN_BITMASK |
				LeaveModelImpl.STATUS_COLUMN_BITMASK |
				LeaveModelImpl.CREATEDATE_COLUMN_BITMASK);

		_finderPathCountBystatus = new FinderPath(LeaveModelImpl.ENTITY_CACHE_ENABLED,
				LeaveModelImpl.FINDER_CACHE_ENABLED, Long.class,
