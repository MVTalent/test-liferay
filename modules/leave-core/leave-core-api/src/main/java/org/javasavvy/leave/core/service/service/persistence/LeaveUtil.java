...
package org.javasavvy.leave.core.service.service.persistence;
 ...
 * @see org.javasavvy.leave.core.service.service.persistence.impl.LeavePersistenceImpl
 * @generated
 */
@ProviderType
public class LeaveUtil {
	...
	*/
	public static Leave findByUuid_First(String uuid,
		OrderByComparator<Leave> orderByComparator)
		throws org.javasavvy.leave.core.service.exception.NoSuchLeaveException {
	...
	* @return the matching leaves
	*/
	public static List<Leave> findBystatus(long groupId, int status) {
	...
	* @return the range of matching leaves
	*/
	public static List<Leave> findBystatus(long groupId, int status, int start,
		int end) {
	...
	* @throws NoSuchLeaveException if a matching leave could not be found
	*/
	public static Leave findBystatus_First(long groupId, int status,
		OrderByComparator<Leave> orderByComparator)
		throws org.javasavvy.leave.core.service.exception.NoSuchLeaveException {
		return getPersistence()
	...
	* @return the first matching leave, or <code>null</code> if a matching leave could not be found
	*/
	public static Leave fetchBystatus_First(long groupId, int status,
		OrderByComparator<Leave> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchLeaveException if a matching leave could not be found
	*/
	public static Leave findBystatus_Last(long groupId, int status,
		OrderByComparator<Leave> orderByComparator)
		throws org.javasavvy.leave.core.service.exception.NoSuchLeaveException {
		return getPersistence()
	...
	* @return the last matching leave, or <code>null</code> if a matching leave could not be found
	*/
	public static Leave fetchBystatus_Last(long groupId, int status,
		OrderByComparator<Leave> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchLeaveException if a leave with the primary key could not be found
	*/
	public static Leave[] findBystatus_PrevAndNext(long leaveId, long groupId,
		int status, OrderByComparator<Leave> orderByComparator)
		throws org.javasavvy.leave.core.service.exception.NoSuchLeaveException {
		return getPersistence()
				   .findBystatus_PrevAndNext(leaveId, groupId, status,
			orderByComparator);
	}
