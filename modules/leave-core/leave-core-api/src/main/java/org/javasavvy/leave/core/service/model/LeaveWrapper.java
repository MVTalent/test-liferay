...
package org.javasavvy.leave.core.service.model;
...
public class LeaveWrapper implements Leave, ModelWrapper<Leave> {
	...
	*/
	...
	/**
	* Returns the status by user ID of this leave.
	*
	* @return the status by user ID of this leave
	*/
	@Override
	public long getStatusByUserId() {
		return _leave.getStatusByUserId();
	}

	/**
	* Returns the status by user name of this leave.
	*
	* @return the status by user name of this leave
	*/
	@Override
	public String getStatusByUserName() {
		return _leave.getStatusByUserName();
	}

	/**
	* Returns the status by user uuid of this leave.
	*
	* @return the status by user uuid of this leave
	*/
	@Override
	public String getStatusByUserUuid() {
		return _leave.getStatusByUserUuid();
	}

	/**
	* Returns the status date of this leave.
	*
	* @return the status date of this leave
	*/
	@Override
	public Date getStatusDate() {
		return _leave.getStatusDate();
	}
	...
	*/
	...
	/**
	* Returns <code>true</code> if this leave is approved.
	*
	* @return <code>true</code> if this leave is approved; <code>false</code> otherwise
	*/
	@Override
	public boolean isApproved() {
		return _leave.isApproved();
	}
	...
	/**
	* Returns <code>true</code> if this leave is denied.
	*
	* @return <code>true</code> if this leave is denied; <code>false</code> otherwise
	*/
	@Override
	public boolean isDenied() {
		return _leave.isDenied();
	}

	/**
	* Returns <code>true</code> if this leave is a draft.
	*
	* @return <code>true</code> if this leave is a draft; <code>false</code> otherwise
	*/
	@Override
	public boolean isDraft() {
		return _leave.isDraft();
	}
	...
	/**
	* Returns <code>true</code> if this leave is expired.
	*
	* @return <code>true</code> if this leave is expired; <code>false</code> otherwise
	*/
	@Override
	public boolean isExpired() {
		return _leave.isExpired();
	}

	/**
	* Returns <code>true</code> if this leave is inactive.
	*
	* @return <code>true</code> if this leave is inactive; <code>false</code> otherwise
	*/
	@Override
	public boolean isInactive() {
		return _leave.isInactive();
	}

	/**
	* Returns <code>true</code> if this leave is incomplete.
	*
	* @return <code>true</code> if this leave is incomplete; <code>false</code> otherwise
	*/
	@Override
	public boolean isIncomplete() {
		return _leave.isIncomplete();
	}
	...
	/**
	* Returns <code>true</code> if this leave is pending.
	*
	* @return <code>true</code> if this leave is pending; <code>false</code> otherwise
	*/
	@Override
	public boolean isPending() {
		return _leave.isPending();
	}

	/**
	* Returns <code>true</code> if this leave is scheduled.
	*
	* @return <code>true</code> if this leave is scheduled; <code>false</code> otherwise
	*/
	@Override
	public boolean isScheduled() {
		return _leave.isScheduled();
	}
	...
	*/
	...
	/**
	* Sets the status by user ID of this leave.
	*
	* @param statusByUserId the status by user ID of this leave
	*/
	@Override
	public void setStatusByUserId(long statusByUserId) {
		_leave.setStatusByUserId(statusByUserId);
	}

	/**
	* Sets the status by user name of this leave.
	*
	* @param statusByUserName the status by user name of this leave
	*/
	@Override
	public void setStatusByUserName(String statusByUserName) {
		_leave.setStatusByUserName(statusByUserName);
	}

	/**
	* Sets the status by user uuid of this leave.
	*
	* @param statusByUserUuid the status by user uuid of this leave
	*/
	@Override
	public void setStatusByUserUuid(String statusByUserUuid) {
		_leave.setStatusByUserUuid(statusByUserUuid);
	}

	/**
	* Sets the status date of this leave.
	*
	* @param statusDate the status date of this leave
	*/
	@Override
	public void setStatusDate(Date statusDate) {
		_leave.setStatusDate(statusDate);
	}
