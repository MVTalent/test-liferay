 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ru.rostec.service.impl.ProcessLocalServiceImpl}.
 * </p>
 *
...
public abstract class ProcessLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link ru.rostec.service.ProcessLocalServiceUtil} to access the process local service.
	 */
	...
	public Process createProcess(long id) {
		return processPersistence.create(id);
	}
	...
	public Process deleteProcess(long id) throws PortalException {
		return processPersistence.remove(id);
	}
	...
	public Process fetchProcess(long id) {
		return processPersistence.fetchByPrimaryKey(id);
	}
	...
	public Process getProcess(long id) throws PortalException {
		return processPersistence.findByPrimaryKey(id);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("ru.rostec.model.Process",
			processLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("ru.rostec.model.Process");
	}
