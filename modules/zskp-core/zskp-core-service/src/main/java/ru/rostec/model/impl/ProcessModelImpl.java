...
import ru.rostec.model.ProcessSoap;
...
public class ProcessModelImpl extends BaseModelImpl<Process>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(ru.rostec.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.ru.rostec.model.Process"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(ru.rostec.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.ru.rostec.model.Process"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(ru.rostec.service.util.ServiceProps.get(
				"lock.expiration.time.ru.rostec.model.Process"));
	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Process, Object>() {
				...
				@Override
				public void accept(Process process, Object id) {
