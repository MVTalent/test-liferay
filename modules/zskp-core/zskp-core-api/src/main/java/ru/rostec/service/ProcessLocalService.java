...
public interface ProcessLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProcessLocalServiceUtil} to access the process local service. Add custom service methods to {@link ru.rostec.service.impl.ProcessLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Process addProcess(ServiceContext serviceContext,
	...
	*/
	...
	public Process createProcess(long id);
	...
	*/
	...
	public Process deleteProcess(long id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Process fetchProcess(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Process getProcess(long id) throws PortalException;
	...
	*/
	...
	public Process updateStatus(long userId, long processId, int status,
