...
/**
 * Provides the local service interface for Kind. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see KindLocalServiceUtil
...
public interface KindLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KindLocalServiceUtil} to access the kind local service. Add custom service methods to {@link ru.rostec.service.impl.KindLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
