 ...
 * {@link ru.rostec.service.impl.TypeLocalServiceImpl} and is the
 ...
 * @see ru.rostec.service.base.TypeLocalServiceBaseImpl
...
public class TypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link ru.rostec.service.impl.TypeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static ru.rostec.model.Type addType(ru.rostec.model.Type type) {
	...
	* @return the new type
	*/
	public static ru.rostec.model.Type createType(long id) {
	...
	*/
	public static ru.rostec.model.Type deleteType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @return the type that was removed
	*/
	public static ru.rostec.model.Type deleteType(ru.rostec.model.Type type) {
	...
	*/
	...
	public static ru.rostec.model.Type fetchType(long id) {
	...
	* @throws PortalException if a type with the primary key could not be found
	*/
	public static ru.rostec.model.Type getType(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<ru.rostec.model.Type> getTypes(int start,
		int end) {
	...
	*/
	public static ru.rostec.model.Type updateType(ru.rostec.model.Type type) {
	...
	static {
		...
		ServiceTracker<TypeLocalService, TypeLocalService> serviceTracker = new ServiceTracker<TypeLocalService, TypeLocalService>(bundle.getBundleContext(),
				TypeLocalService.class, null);
