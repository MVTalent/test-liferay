 ...
 * @see TypePersistence
 * @see ru.rostec.service.persistence.impl.TypePersistenceImpl
 * @generated
 */
@ProviderType
public class TypeUtil {
	...
	*/
	public static Type remove(long id)
		throws ru.rostec.exception.NoSuchTypeException {
	...
	*/
	...
	static {
		...
		ServiceTracker<TypePersistence, TypePersistence> serviceTracker = new ServiceTracker<TypePersistence, TypePersistence>(bundle.getBundleContext(),
				TypePersistence.class, null);
