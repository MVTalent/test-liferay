...
/**
 * Provides the local service interface for ZskpProcess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ZskpProcessLocalServiceUtil
...
public interface ZskpProcessLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ZskpProcessLocalServiceUtil} to access the zskp process local service. Add custom service methods to {@link ru.rostec.service.impl.ZskpProcessLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ZskpProcess addZskpProcess(ZskpProcess zskpProcess);
	...
	*/
	...
	public ZskpProcess createZskpProcess(long processId);
	...
	*/
	...
	public ZskpProcess deleteZskpProcess(long processId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ZskpProcess deleteZskpProcess(ZskpProcess zskpProcess);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ZskpProcess fetchZskpProcess(long processId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ZskpProcess getZskpProcess(long processId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ZskpProcess> getZskpProcesses(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ZskpProcess updateZskpProcess(ZskpProcess zskpProcess);
}